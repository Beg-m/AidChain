        ...
        {success ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <select
                className="w-full p-4 bg-white/5 border border-white/20 rounded-lg focus:ring-2 focus:ring-blue-400 focus:border-transparent text-white transition-all duration-300"
              ...
              >
                ...
                <option value="Kızılay" className="bg-gray-800">Kızılay (Türk Kızılayı)</option>
                <option value="AKUT" className="bg-gray-800">AKUT (Arama Kurtarma Derneği)</option>
                <option value="Ahbap Derneği" className="bg-gray-800">Ahbap Derneği</option>
                <option value="İHH" className="bg-gray-800">İHH (İnsan Hak ve Hürriyetleri İnsani Yardım Vakfı)</option>
                <option value="Deniz Feneri Derneği" className="bg-gray-800">Deniz Feneri Derneği</option>
                <option value="Hayata Destek Derneği" className="bg-gray-800">Hayata Destek Derneği (Support to Life)</option>
                ...
                <option value="TİDER" className="bg-gray-800">TİDER (Temel İhtiyaç Derneği)</option>
                <option value="Sadakataşı Derneği" className="bg-gray-800">Sadakataşı Derneği</option>
                <option value="Beşir Derneği" className="bg-gray-800">Beşir Derneği</option>
                <option value="Çorbada Tuzun Olsun Derneği" className="bg-gray-800">Çorbada Tuzun Olsun Derneği</option>
                <option value="ACDC" className="bg-gray-800">ACDC (Afet Çalışmaları Derneği)</option>
                <option value="İlk Umut Derneği" className="bg-gray-800">İlk Umut Derneği</option>
              </select>
            </div>
